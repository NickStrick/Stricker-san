...
export function SeperatorWave({ type='', flip=false, waveClass='', color='var(--bg)', height=64 }: { type?: string; flip?: boolean; waveClass?: string; color?: string; height?: number }) {
